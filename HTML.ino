...
void setupWeb(void) {
  server.on("/", []() {
   ...
   /* if (WiFiConf.sta_language[0]=='1'){
    ...
    content +=F("</fieldset>");
    content +=F("<fieldset>");
              content +=F("<legend><a href='/mqtt_conf'>Cài Đặt HC2</a></legend>");
              content +=F("<li>Phần này mục đích điền các thông số MQTT Server");
    content +=F("</fieldset>");
    content +=F("<fieldset>");
    ...
    content +=F("</fieldset>");
    content +=F("<fieldset>");
    content +=F("<legend><a href='/mqtt_conf'>MQTT Setting</a></legend>");
    content +=F("<li>Phần này mục đích điền các thông số MQTT Server");
    content +=F("</fieldset>");
    content +=F("<fieldset>");
